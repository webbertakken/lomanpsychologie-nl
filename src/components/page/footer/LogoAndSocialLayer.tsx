...
const LogoAndSocialLayer = ({}: Props): JSX.Element => {
  return (
    <div className="flex flex-col items-center md:flex-row md:justify-between mb-7">
      <Logo className="h-10 select-none cursor-pointer mr-3" />
